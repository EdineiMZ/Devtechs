...
/**
 * Thin HTTP proxy that forwards requests to the upstream support-service.
 * Injects API key identity headers so the backend can attribute the request.
 */
@Injectable()
