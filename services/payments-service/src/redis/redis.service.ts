...
/**
 * Redis wrapper for payments-service.
 *
 * DEV TOLERANCE: lazyConnect + null retry so a missing Redis never
 * crashes the service in development. All operations fall back to
 * no-op / null. Production retains hard retry behaviour.
 */
@Injectable()
export class RedisService implements OnModuleInit, OnModuleDestroy {
  ...
  /** Expose the raw client for advanced use cases. */
  getClient(): Redis {
    return this.client;
  }
