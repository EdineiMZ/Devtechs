...
/**
 * Global exception normalizer for rh-service.
 *
 * Produces the same body shape the auth-service filter emits, so the
 * frontend can branch on `error`/`statusCode` without knowing which
